...
import com.netby.common.util.emoji.Emoji;
import com.netby.common.util.emoji.EmojiManager;
import com.netby.common.util.emoji.EmojiParser;

import java.util.List;
import java.util.Set;

/**
 * Fork hutool工具中的帮助类，减少三方依赖
 * @author: byg
 */
